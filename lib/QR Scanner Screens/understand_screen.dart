...
class UnderstandScreen extends StatefulWidget {
  ...
  static const String id = 'UnderstandScreen';

  @override
  _UnderstandScreenState createState() => _UnderstandScreenState();
}
...
class CustomTimerPainter extends CustomPainter {
  ...
  get getIsFinished => this.isFinished;
  set setIsFinished(bool isFinished) => this.isFinished = isFinished;
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (animation!.value == 0) {
      isFinished = animation!.isCompleted;
    }
  }
