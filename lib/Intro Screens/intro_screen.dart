    ...
    return IntroductionScreen(
      ...
      pages: [
        ...
        PageViewModel(
          title: "F",
          body: "I love you",
          image: introImage('assets/discovret_logo_name.png'),
      ...
      next: Icon(Icons.arrow_forward, color: Colors.white, size: 40),
      done: Text(
        'Getting Started',
        style: TextStyle(
      ...
      dotsDecorator: const DotsDecorator(
        size: Size(20.0, 20.0), //size of dots
        color: Colors.white, //color of dots
        activeSize: Size(30.0, 15.0), activeColor: Colors.greenAccent,
